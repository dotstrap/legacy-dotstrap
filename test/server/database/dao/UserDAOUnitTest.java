...
public class UserDAOUnitTest {
    ...
    public void testCreate() throws DatabaseException {
        ...
        User userTest1 = new User("Create1", "pass1", "first1", "last1", "email1", 1, 1);
        User userTest2 = new User("Create2", "pass2", "first2", "last2", "email2", 2, 2);
        User userTest3 = new User("Create3", "pass3", "first3", "last3", "email3", 3, 3);
    ...
    public void testUpdate() throws DatabaseException {
        ...
        User userTest1 = new User("Update1", "pass1", "first1", "last1", "email1", 1, 1);
        User userTest2 = new User("Update2", "pass2", "first2", "last2", "email2", 2, 2);
        User userTest3 = new User("Update3", "pass3", "first3", "last3", "email3", 3, 3);
    ...
    public void testDelete() throws DatabaseException {
        ...
        User userTest1 = new User("Delete1", "pass1", "first1", "last1", "email1", 1, 1);
        User userTest2 = new User("Delete2", "pass2", "first2", "last2", "email2", 2, 2);
        User userTest3 = new User("Delete3", "pass3", "first3", "last3", "email3", 3, 3);
