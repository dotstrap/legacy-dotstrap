...
//                        cCom.getSampleImage(new GetSampleImageParameters("validate", "validate", 1));
//        assertEquals(result.getLink(), "TempFilePath");
//        // invalid user
//        GetSampleImageResult result2 =
//                        cCom.getSampleImage(new GetSampleImageParameters("invalid", "validate", 1));
//        assertEquals(false, result2.isValidUser());
//        // invalid project
//        GetSampleImageResult result3 =
//                        cCom.getSampleImage(new GetSampleImageParameters("validate", "validate",
//                                        100));
