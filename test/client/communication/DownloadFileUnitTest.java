...
public class DownloadFileUnitTest {
  ...
  public void testDownloadValidFile1() throws DatabaseException {
    try {
      DownloadFileResponse result = clientComm.downloadFile(
          new DownloadFileRequest("Records/images/1890_image0.png"));
      ...
      logger.log(Level.FINER, "STACKTRACE: ", e);
    }
  }
  ...
  public void testDownloadValidFile2() throws DatabaseException {
    try {
      DownloadFileResponse result = clientComm.downloadFile(
          new DownloadFileRequest("Records/images/1890_image19.png"));
      boolean didDownload = false;
      if (result.getFileBytes().length > 0) {
        didDownload = true;
      }
  ...
  public void testDownloadValidFile3() throws DatabaseException {
    try {
      DownloadFileResponse result = clientComm.downloadFile(
          new DownloadFileRequest("Records/images/draft_image9.png"));
      boolean didDownload = false;
      if (result.getFileBytes().length > 0) {
        didDownload = true;
      }
  ...
  public void testDownloadInvalidFile() throws DatabaseException {
    try {
      DownloadFileResponse result = clientComm
          .downloadFile(new DownloadFileRequest("Records/images/INVALID.png"));
      boolean didDownload = false;
      if (result.getFileBytes().length > 0) {
        didDownload = true;
      }
