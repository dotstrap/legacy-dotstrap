...
public class Constants {
  ...
  /** The Constant DOUBLE_HSPACE. */
  public static Dimension DOUBLE_HSPACE = new Dimension(HSPACING * 2, 0);

  /** The Constant TRIPLE_HSPACE. */
  ...
  /** The Constant DOUBLE_VSPACE. */
  public static Dimension DOUBLE_VSPACE = new Dimension(0, VSPACING * 2);

  /** The Constant TRIPLE_VSPACE. */
